...
dataset_file = "fhv_tripdata_{{ execution_date.strftime(\'%Y-%m\') }}.csv.gz"
...
def format_to_parquet(src_file):
    if not src_file.endswith('csv.gz'):
        logging.error("Can only accept source file in CSV.GZ format, for the moment")
        return
